...
export function CanvasRevealEffectDemo(props) {
    ...
    return (
        <>
            <div className="py-[40px] flex items-center justify-center bg-white dark:bg-[#0e0e0e] w-full gap-[8px] mx-auto px-8">
...
const Card = ({
    ...
    return (
        <div
            ...
            className=" border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2] max-w-sm w-full p-4 h-[30rem] relative overflow-hidden"
        >
